...
if(isset($_POST['email'])){
    ...
    $sql="update gpxcollaborate_users set passwordResetId='$token' where email='$email'";
    ...
    $email_body = "Change your password here $passwordLink";
    sendEmailNotification("GPX Collaborate - Forget password", $email_body, $email);
          ...
          <div class="card bg-secondary border-0">
            ...
            <?php }?>
                ...
                <div class="text-center">
                  <input type="submit" class="btn btn-primary mt-4" value="Send verification email">
                </div>
                 <div class="text-center">
                     <Br>
                     <a href="./">Proceed to Home.</a>
                </div>
